...
namespace Vk.Bot.Framework
{
    ...
    public abstract class UpdateHandlerBase : IUpdateHandler
    {
        ...
        public abstract bool CanHandleUpdate(IBot bot, GroupUpdate update);
        ...
        public abstract Task<UpdateHandlingResult> HandleUpdateAsync(IBot bot, GroupUpdate update);
    }
}